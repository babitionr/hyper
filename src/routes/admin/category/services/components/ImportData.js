...
function ImportData({ handleChange }) {
  ...
  const handleImportData = async (e) => {
    ...
    const res = await ImportDataService.importService(file, branchUuid);
    if (res === 200) {
    ...
    <div className="flex items-center gap-4">
      <button
        ...
        onClick={() => {
          ...
          element.href = ' https://dental-dev.s3.ap-southeast-1.amazonaws.com/image/template/importService.csv';
          element.click();
        }}
      >
        Tải Template
