      ...
      if (data.message) {
        if (!uuid) {
          await Message.success({
            text: 'Tạo thông tin thuốc thành công',
            title: 'Thành Công',
      ...
      <div>
        ...
        <div>
          <div className="w-full flex justify-between gap-4">
            <Form.Item className="w-4/12" label="Mã thuốc" name="code">
              <Input
                placeholder="Nhập mã thuốc"
                disabled
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: 'Nhập tên thuốc',
                },
              ]}
            >
              <Input
                placeholder="Nhập tên thuốc"
                className="h-10 text-sm font-normal block w-full rounded-lg border border-gray-200  py-[7px] px-4 focus:outline-none"
              />
            </Form.Item>
