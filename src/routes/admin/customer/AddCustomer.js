import { Form, Input, DatePicker, Select, Modal, Button, Checkbox, ConfigProvider } from 'antd';
                ...
                >
                  <span className="text-4xl pr-2">x</span>
                      ...
                      <div className="p-2">
                        ...
                        >
                          ...
                          {/* <div className="w-[55px] h-[45px] bg-teal-600 opacity-80 absolute right-0 bottom-0 rounded-tl-[0.625rem] rounded-br-[0.625rem] flex items-center justify-center">
                            ...
                            {!imageUrl && (
                              <div className="absolute bottom-10 left-2 z-0 text-center custom1">
                                {faceId === true ? (
                          ...
                          <div className="gap-1 w-full">
                            <div className="w-full justify-between mt-3 custom1">
                              <Form.Item
                              ...
                              ></Form.Item>
                              <Input
                                className="h-10 w-full text-sm font-normal block rounded-lg border border-gray-200 custom2 py-[7px] px-4 mb-6 custom1"
                                placeholder="Nhập họ và tên"
                              />
                            </div>
                            <div className="w-full flex justify-between gap-4 custom1 mb-6">
                              <div className="w-full">
                                <Form.Item
                                  className="!m-0"
                                  name="dateOfBirth"
                            ...
                            <div className="w-full flex justify-between gap-4 custom1">
                              <div className="w-full">
                                <Form.Item
                                ...
                                <Input
                                  ...
                                  className="h-10 text-sm font-normal block w-full rounded-lg border border-gray-200  py-[7px] px-4 focus:outline-none custom2 custom 1"
                                />
                              </div>
                              <div className="w-full">
                                <Form.Item
                      ...
                      <div className=" px-2 pb-6 ">
                        ...
                        <div className="flex justify-between gap-6 custom1 mb-4">
                          <div className="w-full custom1">
                            <Form.Item className="w-1/4 !m-0" label="Số nhà, đường" name="street"></Form.Item>
                            <Input
                          ...
                          <div className="w-full custom1">
                            <Form.Item className="w-1/4 !m-0" name="province" label="Tỉnh/TP">
                              {/* <Input
                        ...
                        /> */}
                          ...
                          <div className="w-full custom1">
                            <Form.Item className="w-1/4 !m-0" name="district" label="Quận/ Huyện"></Form.Item>
                            <Select
                              className="!w-full !rounded-lg  text-sm font-normal custom1"
                          ...
                          <div className="w-full custom1">
                            <Form.Item className="w-1/4 !m-0" name="ward" label="Phường/Xã"></Form.Item>{' '}
                            <Select
                              className="!w-full !rounded-lg  text-sm font-normal custom1"
                        ...
                        <div className="flex flex-row gap-6 custom1 mb-4">
                          <div className="w-full">
                            <Form.Item className="w-1/3 !m-0 custom1" label="Nghề nghiệp" name="jobTitle"></Form.Item>
                            <Input
                              className="h-10 text-sm font-normal block w-full rounded-lg border border-gray-200  py-[7px] px-4 focus:outline-none custom1 custom2"
                          ...
                          <div className="w-full">
                            ...
                            <Select
                              mode="multiple"
                              className="w-full !rounded-lg  text-sm font-normal custom1 custom2"
                              allowClear
                        ...
                        <div className="flex flex-row gap-6 custom1 mb-4">
                          ...
                          <div className="w-full custom1">
                            <Form.Item className="w-1/3 !m-0" name="customerGroup" label="Nhóm khách hàng"></Form.Item>
                            <Select
                              allowClear
                              className="!w-full !rounded-lg  text-sm font-normal custom1"
                        ...
                        <div className="w-full">
                          <Form.Item className="w-full custom1 !m-0" name="description" label="Mô tả"></Form.Item>

                          <Input.TextArea
                            rows={2}
                            className=" w-full text-sm font-normal block !bg-white rounded-lg border border-gray-200  py-[7px] px-4 custom1"
                            placeholder=""
                          />
                        </div>
                      </div>
