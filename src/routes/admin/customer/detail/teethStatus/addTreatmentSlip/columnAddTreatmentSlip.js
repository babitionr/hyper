...
export const ColumnAddTreatmentSlip = (handleGetUuidService, deleteItemServiceList) => {
  return [
    {
      title: 'Tên dịch vụ',
      name: 'serviceNamne',
    ...
    },
    {
      ...
      tableItem: {
        width: 150,
        render: (text, data) => data.saleOrderServiceTeethDtoList?.map((ele) => ele.teethNumber).join(', '),
      },
    },
    {
      title: 'Chuẩn đoán',
