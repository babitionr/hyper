...
import { Form, Input, Modal, Select, DatePicker, Button, Tooltip, InputNumber, Tabs } from 'antd';
  ...
  return (
    <div>
      <Modal
        ...
        footer={null}
        className="!w-9/12 min-w-min pb-0 z-10"
        closable={false}
      >
          ...
          <div>
            ...
            <div>
              ...
              <div className="w-full flex justify-between gap-4">
                ...
                <Form.Item className="w-6/12" label="Đơn vị" name="uomName">
                  <Input
                    disabled
      ...
      <Modal
        ...
        title={
          <div className="flex justify-between">
            <div className="text-base font-bold">{'Sơ đồ vị trí răng'.toUpperCase()}</div>
            <button
              className=""
              onClick={() => {
                cancelSelectTeeth();
