  ...
  const items = [
    {
      label: 'Hồ sơ',
      key: '1',
      children: checkPermission('MANAGE_CUSTOMER_INFO') ? (
    ...
    },
    {
      label: 'Công nợ',
      key: '4',
      children: checkPermission('MANAGE_CUSTOMER_DEBT') ? (
        tabName === 'Debt' ? (
          <Dept data={data} idCustomer={idCustomer} checkPermission={checkPermission} />
        ) : (
          <></>
        )
      ) : null,
