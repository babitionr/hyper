...
import { ColumnTelesales } from '../../columns/columnTelesales';
const MarketingTelesales = () => {
  const getData = () => {
    const data = [];
    const data1 = [
      'Chi nhánh 1',
    ...
    data1.forEach((ele) =>
      data.push({
        name: ele,
        soCuocGoi: '150',
        khachHangDaTaoThongTin: '150',
        khachHangTiemNang: '150',
        soLichHenDaLen: '100',
      }),
    );
...
export default MarketingTelesales;
