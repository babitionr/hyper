...
import { ColumnExportStock } from '../../columns/columnExportStock';
import { Select, DatePicker } from 'antd';
import { ExportStockMini } from './exportStockMini';
...
export const ExportStock = () => {
  ...
  const [handleChange, DataTable] = HookDataTable({
    ...
    Get: getData,
    columns: ColumnExportStock({ handleEdit, handleDelete }),
    loadFirst: false,
    save: false,
    expandable: {
      expandedRowRender: (record) => (
        <div className="pl-4">
          <ExportStockMini record={record}></ExportStockMini>
        </div>
      ),
    },
    rightHeader: (
      <div className="ml-2 xl:flex gap-2 2xl:gap-5">
        ...
        <div className="flex gap-2  pt-2 xl:pt-0 2xl:gap-5">
          ...
          <button
            ...
            type="button"
            onClick={() => {
              navigate(routerLinks('ExportInventoryManagementAddNew'));
            }}
          >
