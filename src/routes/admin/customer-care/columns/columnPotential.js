...
export const ColumnPotential = ({ handleOpenDetailModal, handleOpenCreateModal }) => {
  return [
    {
    ...
    },
    {
      ...
      tableItem: {
        width: 100,
        render: (text, data, index) => {
          return data?.customer?.dateOfBirth ? moment(data?.customer?.dateOfBirth).format('DD/MM/YYYY') : '';
        },
      },
    },
    {
    ...
    },
    {
      ...
      tableItem: {
        ...
        width: 50,
        render: (text, data, index) => {
          return data?.customer?.dateOfBirth
            ? moment().diff(moment(data?.customer?.dateOfBirth).format('YYYY-MM-DD'), 'years')
            : '';
        },
      },
    },
