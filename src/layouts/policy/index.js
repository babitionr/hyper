...
const Layout = ({ children }) => {
  ...
  return (
    <div className="layout-auth h-screen min-h-screen w-full drop-shadow-2xl flex flex-col relative">
      <div className="bg-white bg-cover bg-center  relative h-max ">
        <div className="flex  h-full">
          <div className="w-full relative justify-between flex-col flex h-max">
            <div
              className={classNames(
                imageURL,
                'bg-cover bg-center w-full min-h-screen lg:min-h-full lg:h-max relative lg:overflow-hidden flex justify-between flex-col overflow-y-scroll',
              )}
            >
