            ...
            {listOfPageItem.current.map((page, index) => (
              <button
                ...
                className={classNames(
                  ...
                  {
                    'text-black-700 hover:text-red-500': pageIndex !== page.index,
                    'bg-red-500 !rounded-md !text-white hover:text-white': pageIndex === page.index,
                    'pointer-events-none': page.disabled || ['next_5', 'prev_5'].includes(page.type),
                    'text-black-300': page.disabled,
                  },
                )}
